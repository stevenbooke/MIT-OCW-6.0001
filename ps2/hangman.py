...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    start_message(secret_word, warnings_remaining)
    ...
    if guesses_remaining > 0:
        congrats_message(secret_word, guesses_remaining)
    else:
        losing_message(secret_word)


def start_message(secret_word, warnings_remaining):
    print('Welcome to the game Hangman!')
    print('I am thinking of a word that is',len(secret_word),'letters long.')
    print('You have', warnings_remaining, 'warnings left.')
    print('-------------')

def congrats_message(secret_word, guesses_remaining):
    unique_chars = []
    for c in secret_word:
        if c not in unique_chars:
            unique_chars.append(c)
    print('Congratulations, you won!')
    print('Your total score for this game is:', guesses_remaining * len(unique_chars))
