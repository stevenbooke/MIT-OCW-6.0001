...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        index = 0
        for c in lowercase:
            mapping[c] = lowercase[(index + shift) % 26]
            index += 1
        index = 0
        for c in uppercase:
            mapping[c] = uppercase[(index + shift) % 26]
            index += 1
        return mapping
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            ...
            for decrypted_word in decrypted_message.split():
...
#    #Example test case (CiphertextMessage)
    ...
    plaintext2 = PlaintextMessage('i love you', 17)
    print('Expected Output: z cfmv pfl')
    print('Actual Output:', plaintext2.get_message_text_encrypted())

    ciphertext2 = CiphertextMessage('z cfmv pfl')
    print('Expected Output:', (9, 'i love you'))
