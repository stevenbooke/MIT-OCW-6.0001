...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for i, c in enumerate(VOWELS_UPPER):
            mapping[c] = vowels_permutation[i].upper()
        for i, c in enumerate(VOWELS_LOWER):
            mapping[c] = vowels_permutation[i].lower()
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        count = 0
        max_count = 0
        permutations_of_vowels = get_permutations(VOWELS_LOWER)
        for p in permutations_of_vowels:
            mapping = self.build_transpose_dict(p)
            for word in self.apply_transpose(mapping).split():
                if is_word(self.valid_words, word):
                    count += 1
            if count > max_count:
                max_count = count
                decrypted_message = self.apply_transpose(mapping)
            count = 0
...
if __name__ == '__main__':
    ...
    message2 = SubMessage("I love you!")
    permutation2 = "ouaie"
    ...
    print("Expected encryption:", "A livu yie!")
    ...
    print("Decrypted message:", enc_message2.decrypt_message()) # returns 'A love you' because: If there are multiple permutations that yield the maximum number of words, return anyone of them.

    message3 = SubMessage("Let's play a game!")
    permutation3 = "iuaoe"
    enc_dict3 = message.build_transpose_dict(permutation3)
    print("Original message:", message3.get_message_text(), "Permutation:", permutation3)
    print("Expected encryption:", "Lut's pliy i gimu")
